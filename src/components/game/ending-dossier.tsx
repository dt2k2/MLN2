...
import type { EndingReport } from "@/game/ending-report";
...
export function EndingDossier({ report }: { report: EndingReport }) {
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-[92vh] w-[min(94vw,960px)] max-w-none gap-0 overflow-y-auto border-gold/35 bg-[oklch(0.12_0.012_60)] p-0 text-left shadow-2xl">
        ...
        {!report.available ? (
          <div className="border-b border-border/70 px-5 py-8 text-sm leading-relaxed text-muted-foreground sm:px-7">
